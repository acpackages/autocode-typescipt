import { Directive, ElementRef, Renderer2, HostListener, NgZone, AfterViewInit, Output, EventEmitter } from '@angular/core';
...
export class AcResizableElementDirective extends AcBase {
  ...
  constructor(elementRef: ElementRef,autocodeAngular:AutocodeService, private renderer: Renderer2, private ngZone: NgZone) {
