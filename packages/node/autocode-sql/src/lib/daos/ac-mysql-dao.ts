...
import { AcDDFunction, AcDDStoredProcedure, AcDDTable, AcDDTableColumn, AcDDTrigger, AcDDView, AcDDViewColumn, AcEnumDDColumnFormat, AcEnumDDColumnProperty, AcEnumDDRowOperation, AcEnumDDSelectMode } from '@autocode-typescript/autocode-data-dictionary';
import { AcEncryption, AcResult } from '@autocode-typescript/autocode';
