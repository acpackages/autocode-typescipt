...
import { AcEnumLogType, AcLogger, AcResult } from "@autocode-typescript/autocode";
import { AcEnumDDRowOperation, AcEnumDDSelectMode } from "@autocode-typescript/autocode-data-dictionary";
