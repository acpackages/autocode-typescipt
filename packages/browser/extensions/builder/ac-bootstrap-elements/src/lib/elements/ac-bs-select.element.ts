...
const ariaProperties : IAcBuilderElementProperty[] = [
  AC_ARIA_PROPERTIES["aria-multiselectable"] as IAcBuilderElementProperty,
...
export const AC_BUILDER_BS_SELECT_ELEMENT: IAcBuilderElement = {
  category: "Bootstrap",
  name: "bs-select",
  tag: "select",
  title: "Select",
  ...
  mediaSvg: AC_BOOTSTRAP_ELEMENT_ICON_SVG.select,
  instanceClass: AcBsSelect
};
