...
export class AcBsStack extends AcBuilderElement {
  override init({ args }: { args: IAcBuilderElementInitArgs }): void {
    // Basic placeholder HTML for Stack
    this.element.innerHTML = `<div>Stack</div>`;
...
export const AC_BUILDER_BS_STACK_ELEMENT: IAcBuilderElement = {
  category: "Bootstrap",
  name: "bs-stack",
  tag: "div",
  title: "Stack",
  ...
  mediaSvg: AC_BOOTSTRAP_ELEMENT_ICON_SVG.stack,
  instanceClass: AcBsStack
};
