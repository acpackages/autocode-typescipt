...
export class AcBsTypography extends AcBuilderElement {
  override init({ args }: { args: IAcBuilderElementInitArgs }): void {
    // Basic placeholder HTML for Typography
    this.element.innerHTML = `<h1>h1. Bootstrap heading</h1>
...
export const AC_BUILDER_BS_TYPOGRAPHY_ELEMENT: IAcBuilderElement = {
  category: "Bootstrap",
  name: "bs-typography",
  tag: "div",
  title: "Typography",
  ...
  mediaSvg: AC_BOOTSTRAP_ELEMENT_ICON_SVG.typography,
  instanceClass: AcBsTypography
};
