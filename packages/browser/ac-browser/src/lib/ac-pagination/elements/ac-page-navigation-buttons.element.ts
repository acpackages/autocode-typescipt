...
export class AcPageNavigationButtons {
  ...
  constructor({ paginationApi }: { paginationApi: AcPaginationApi }) {
    ...
    this.paginationApi.on({eventName:AcEnumPaginationEvent.PageChange,callback:(event:IAcPaginationPageChangeEvent)=>{
  ...
  initElement(){
    ...
    acAddClassToElement({cssClass:AcPaginationCssClassName.acPaginationNavigationButton,element:this.firstButton});
    acAddClassToElement({cssClass:AcPaginationCssClassName.acPaginationNavigationButton,element:this.lastButton});
    acAddClassToElement({cssClass:AcPaginationCssClassName.acPaginationNavigationButton,element:this.previousButton});
    acAddClassToElement({cssClass:AcPaginationCssClassName.acPaginationNavigationButton,element:this.nextButton});
