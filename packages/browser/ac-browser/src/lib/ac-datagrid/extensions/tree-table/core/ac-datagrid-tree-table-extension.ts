...
export class AcDatagridTreeTableExtension extends AcDatagridExtension {
  ...
  set treeDataChildKey(value: string) {
    ...
    this.datagridApi.hooks.execute({ hookName: AcEnumDatagridTreeTableHook.TreeDataChildKeyChange, args: hookArgs });
  }
  ...
  set treeDataDisplayKey(value: string) {
    ...
    this.datagridApi.hooks.execute({ hookName: AcEnumDatagridTreeTableHook.TreeDataDisplayKeyChange, args: hookArgs });
  }
  ...
  set treeDataParentKey(value: string) {
    ...
    this.datagridApi.hooks.execute({ hookName: AcEnumDatagridTreeTableHook.TreeDataParentKeyChange, args: hookArgs });
  }
