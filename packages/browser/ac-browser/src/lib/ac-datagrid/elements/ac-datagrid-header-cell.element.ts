...
export class AcDatagridHeaderCellElement {
  ...
  constructor({ datagridApi, datagridColumn }: { datagridApi: AcDatagridApi, datagridColumn: AcDatagridColumn }) {
    ...
    this.datagridColumn.hooks.subscribe({
      hookName: AcEnumDatagridHook.ColumnSortChange, callback: (event: IAcDatagridColumnSortChangeEvent) => {
        this.renderSort();
      }
    });
    this.datagridColumn.hooks.subscribe({
      hookName: AcEnumDatagridHook.ColumnFilterChange, callback: (event: IAcDatagridColumnFilterChangeEvent) => {
        this.renderFilter();
      }
    });
    this.datagridColumn.hooks.subscribe({
