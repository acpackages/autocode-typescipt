...
export interface IAcDGDragSource {
    /**
...
export interface IAcDGDropTarget {
...
export interface IAcDGDraggingEvent<TData = any, TContext = any> extends AgGridCommon<TData, TContext> {
    event: MouseEvent;
    x: number;
    y: number;
