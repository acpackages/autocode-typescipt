...
export interface IAcDGGenericContextParams<TBeanName extends string, TBeanCollection extends { [key in TBeanName]?: any }> {
...
export interface IAcDGGenericSingletonBean<TBeanName extends string, TBeanCollection extends { [key in TBeanName]?: any }> {
    new (): GenericBean<TBeanName, TBeanCollection>;
}

export interface IAcDGComponentBean {
    preConstruct(): void;
}
 ...
 */
export interface IAcDGBaseBean<TBeanCollection> {
