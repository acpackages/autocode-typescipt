...
import type { IAcDataGridEvent, AgEventListener, AgEventTypeParams } from '../events';
import type {
    GridOptionsService,
    ...
    implements BaseBean<BeanCollection>, Bean, IEventEmitter<EventOrDestroyed<TEventType>>
{
    ...
    public dispatchLocalEvent<TEvent extends IAcDataGridEvent<TEventType>>(event: TEvent): void {
