...
export interface IAcDGContextParams extends GenericContextParams<BeanName, BeanCollection> {
    gridId: string;
    destroyCallback?: () => void;
}

export interface IAcDGSingletonBean extends GenericSingletonBean<BeanName, BeanCollection> {}
...
export interface IAcDGCoreBeanCollection {
    context: Context;
