...
interface IAcDGAutoCompleteEvent<T extends AgAutocompleteEvent> extends IAcDataGridEvent<T> {
    value: string | null;
}
...
export interface IAcDGAutocompleteValidChangedEvent extends IAcDataGridEvent<'eventValidChanged'> {
    isValid: boolean;
