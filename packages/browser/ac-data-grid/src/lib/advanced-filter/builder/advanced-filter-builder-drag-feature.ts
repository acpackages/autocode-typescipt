import type { IAcDataGridEvent } from 'ag-grid-community';
...
export interface IAcDGAdvancedFilterBuilderDragStartedEvent extends IAcDataGridEvent<'advancedFilterBuilderDragStarted'> {
