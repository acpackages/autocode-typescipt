...
export interface IAcDGFilterExpressionEvaluatorParams<ConvertedTValue, TValue = ConvertedTValue> {
...
export interface IAcDGFilterExpressionOperator<ConvertedTValue, TValue = ConvertedTValue> {
    displayValue: string;
    evaluator: FilterExpressionEvaluator<ConvertedTValue, TValue>;
    numOperands: number;
}

export interface IAcDGDataTypeFilterExpressionOperators<ConvertedTValue, TValue = ConvertedTValue> {
    operators: {
...
export interface IAcDGFilterExpressionOperators {
...
export interface IAcDGFilterExpressionOperatorsParams {
...
export interface IAcDGScalarFilterExpressionOperatorsParams<ConvertedTValue> extends FilterExpressionOperatorsParams {
