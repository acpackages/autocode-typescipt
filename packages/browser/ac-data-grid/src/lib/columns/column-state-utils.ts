...
export interface IAcDGModifyColumnsNoEventsCallbacks {
...
export interface IAcDGColumnStateParams {
...
export interface IAcDGColumnState extends ColumnStateParams {
    /** ID of the column */
    colId: string;
}

export interface IAcDGApplyColumnStateParams {
