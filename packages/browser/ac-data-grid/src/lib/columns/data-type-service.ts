...
import type { IAcDataGridGridEvent, ColumnEventType } from '../events';
...
interface IAcDGGroupSafeValueFormatter {
...
export class DataTypeService extends BeanStub implements NamedBean {
    ...
    public addColumnListeners(column: AgColumn): void {
        ...
        const columnListener: IEventListener<ColumnEventName> = (
            event: IAcDataGridGridEvent<any, any, ColumnEventName> & { key: keyof ColumnStateParams }
        ) => {
