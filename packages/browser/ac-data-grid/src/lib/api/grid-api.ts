...
export interface IAcDGDetailGridInfo {
    /**
...
export interface IAcDGStartEditingCellParams {
...
export interface IAcDGGetCellValueParams<TValue = any> {
...
export interface IAcDGGridApi<TData = any>
    ...
    dispatchEvent(event: IAcDataGridEvent): void;
}
