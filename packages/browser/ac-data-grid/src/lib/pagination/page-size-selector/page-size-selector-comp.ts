...
import type { IAcDGPaginationChangedEvent } from '../../events';
...
export class PageSizeSelectorComp extends Component {
    ...
    private handlePaginationChanged(paginationChangedEvent?: WithoutGridCommon<IAcDGPaginationChangedEvent>): void {
