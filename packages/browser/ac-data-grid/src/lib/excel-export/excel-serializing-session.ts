...
export interface IAcDGStyleLinkerInterface {
...
interface IAcDGExcelMixedStyle {
    key: string;
    excelID: string;
    result: ExcelStyle;
}

export interface IAcDGExcelGridSerializingParams extends ExcelWorksheetConfigParams, GridSerializingParams {
