...
export interface IAcDGBaseFloatingFilter {
    /**
...
export interface IFloatingFilter<P = any> extends BaseFloatingFilter {
     ...
     * The event is the IAcDGFilterChangedEvent that the grid fires.
     */
    onParentModelChanged(parentModel: any, filterChangedEvent?: IAcDGFilterChangedEvent | null): void;
...
export interface IAcDGBaseFloatingFilterChange {
