...
export interface IAcDGTextFilterModel extends ISimpleFilterModel {
...
export interface IAcDGTextMatcherParams extends BaseColDefParams {
    /**
...
export interface IAcDGTextMatcher {
    (params: TextMatcherParams): boolean;
}

export interface IAcDGTextFormatter {
