...
interface IAcDGBaseShowColumnMenuParams {
    column?: Column;
    onClosedCallback?: () => void;
}

interface IAcDGBaseShowFilterMenuParams {
    column: Column;
    containerType: ContainerType;
}

interface IAcDGMouseShowMenuParams {
    mouseEvent: MouseEvent | Touch;
    positionBy: 'mouse';
}

interface IAcDGButtonShowMenuParams {
    buttonElement: HTMLElement;
    positionBy: 'button';
}

interface IAcDGAutoShowMenuParams {
    positionBy: 'auto';
}
