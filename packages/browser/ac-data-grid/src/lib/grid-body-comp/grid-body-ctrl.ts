...
import type { IAcDGRowResizeEndedEvent, IAcDGRowResizeStartedEvent } from '../events';
...
export class GridBodyCtrl extends BeanStub {
    ...
    private toggleRowResizeStyles(params: IAcDGRowResizeStartedEvent | IAcDGRowResizeEndedEvent) {
