import type { AgColumn, ElementParams, IAcDGFilterOpenedEvent, IFilterComp, IconName } from 'ag-grid-community';
import {
    Component,
    FilterWrapperComp,
    KeyCode,
...
export class AcDGToolPanelFilterComp extends Component<ToolPanelFilterCompEvent> {
    ...
    private onFilterOpened(event: IAcDGFilterOpenedEvent): void {
