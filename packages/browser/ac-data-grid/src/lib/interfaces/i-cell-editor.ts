...
export interface IAcDGBaseCellEditor {
...
export interface IAcDGDefaultProvidedCellEditorParams {
    suppressPreventDefault?: boolean;
}

export interface IAcDGGetCellEditorInstancesParams<TData = any> extends GetCellsParams<TData> {}
