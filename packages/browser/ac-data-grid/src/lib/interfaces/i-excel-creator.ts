...
// Excel Styles
export interface IAcDGExcelStyle {
...
export interface IAcDGExcelAlignment {
    /**
...
export interface IAcDGExcelBorders {
...
export interface IAcDGExcelBorder {
    /**
...
export interface IAcDGExcelFont {
    /**
...
export interface IAcDGExcelInterior {
...
// Excel Structure
export interface IAcDGExcelWorksheet {
    name: string;
    table: ExcelTable;
}

export interface IAcDGExcelTable {
    columns: ExcelColumn[];
    rows: ExcelRow[];
}

export interface IAcDGExcelColumn {
    min?: number;
    max?: number;
    outlineLevel?: number;
    width?: number;
...
export interface IAcDGExcelRow {
    /** Collapsed state. */
    collapsed?: boolean;
    /** Hidden state. */
    hidden?: boolean;
...
export interface IAcDGExcelCell {
...
export interface IAcDGExcelImagePosition {
...
export interface IAcDGExcelHeaderFooterImage extends BaseImage {
...
export interface IAcDGExcelImage extends BaseImage {
    /**
...
export interface IAcDGExcelData {
...
export interface IAcDGExcelRelationship {
    Id: string;
    Type: string;
    Target: string;
}

export interface IAcDGExcelContentType {
...
export interface IAcDGExcelOOXMLTemplate {
...
export interface IAcDGExcelSheetNameGetterParams<TData = any, TContext = any> extends AgGridCommon<TData, TContext> {}

export type ExcelSheetNameGetter = (params?: ExcelSheetNameGetterParams) => string;

export interface IAcDGExcelFreezeRowsGetterParams<TData = any, TContext = any> extends AgGridCommon<TData, TContext> {
    /** Row node. */
    node?: IRowNode<TData>;
}

export interface IAcDGExcelFreezeColumnsGetterParams<TData = any, TContext = any> extends AgGridCommon<TData, TContext> {
    column: Column;
}
...
export interface IAcDGColumnWidthCallbackParams {
    column: Column | null;
    index: number;
}

export interface IAcDGRowHeightCallbackParams {
    rowIndex: number;
}

export interface IAcDGExcelWorksheetConfigParams {
    /**
...
interface IAcDGExcelFileParams {
    /**
...
export interface IAcDGExcelExportParams extends ExcelFileParams, ExcelWorksheetConfigParams, ExportParams<ExcelRow[]> {}
export interface IAcDGExcelExportMultipleSheetParams extends ExcelFileParams {
    /**
...
export interface IAcDGExcelHeaderFooterConfig {
...
export interface IAcDGExcelHeaderFooterContent {
...
export interface IAcDGExcelSheetMargin {
    /**
...
export interface IAcDGExcelSheetPageSetup {
    /**
...
export interface IAcDGExcelTableConfig {
    /**
