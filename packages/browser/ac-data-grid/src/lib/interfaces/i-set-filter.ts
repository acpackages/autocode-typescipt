...
export interface IAcDGSetFilterModel extends ProvidedFilterModel {
    filterType?: 'set';
 ...
 * @param V type of value in the Set Filter
 */
export interface IAcDGSetFilterValuesFuncParams<TData = any, V = string> extends AgGridCommon<TData, any> {
