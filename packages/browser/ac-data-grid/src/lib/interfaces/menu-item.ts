...
export interface IAcDGMenuItemLeafDef<TData = any, TContext = any> {
...
export interface IAcDGMenuItemDef<TData = any, TContext = any> extends MenuItemLeafDef<TData, TContext> {
    /**
...
export interface IAcDGBaseMenuItemParams<TData = any, TContext = any> extends MenuItemDef, AgGridCommon<TData, TContext> {
...
export interface IAcDGBaseMenuItem {
