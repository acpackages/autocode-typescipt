...
export interface IAcDGGetCellsParams<TData = any> {
...
export interface IAcDGRefreshCellsParams<TData = any> extends GetCellsParams<TData> {
...
export interface IAcDGFlashCellsParams<TData = any> extends GetCellsParams<TData> {
