import type { IAcDataGridEvent, SelectionEventSourceType } from '../events';
...
export interface IAcDGRowNodeEvent<T extends RowNodeEventType, TData = any> extends IAcDataGridEvent<T> {
    node: IRowNode<TData>;
}

export interface IAcDGRowNodeSelectedEvent<TData = any> extends RowNodeEvent<'rowSelected', TData> {}
export interface IAcDGRowNodePinnedEvent<TData = any> extends RowNodeEvent<'rowPinned', TData> {}
export interface IAcDGMouseEnterEvent<TData = any> extends RowNodeEvent<'mouseEnter', TData> {}
export interface IAcDGMouseLeaveEvent<TData = any> extends RowNodeEvent<'mouseLeave', TData> {}
export interface IAcDGHeightChangedEvent<TData = any> extends RowNodeEvent<'heightChanged', TData> {}
export interface IAcDGRowIndexChangedEvent<TData = any> extends RowNodeEvent<'rowIndexChanged', TData> {}
export interface IAcDGTopChangedEvent<TData = any> extends RowNodeEvent<'topChanged', TData> {}
export interface IAcDGExpandedChangedEvent<TData = any> extends RowNodeEvent<'expandedChanged', TData> {}
/** @deprecated v33 Use the `modelUpdated` event instead and calculate whether the first child has changed. */
export interface IAcDGFirstChildChangedEvent<TData = any> extends RowNodeEvent<'firstChildChanged', TData> {}
/** @deprecated v33 Use the `modelUpdated` event instead and calculate whether the last child has changed. */
export interface IAcDGLastChildChangedEvent<TData = any> extends RowNodeEvent<'lastChildChanged', TData> {}
/** @deprecated v33 Use the `modelUpdated` event instead and calculate whether the child index has changed. */
export interface IAcDGChildIndexChangedEvent<TData = any> extends RowNodeEvent<'childIndexChanged', TData> {}
export interface IAcDGAllChildrenCountChangedEvent<TData = any> extends RowNodeEvent<'allChildrenCountChanged', TData> {}
export interface IAcDGUiLevelChangedEvent<TData = any> extends RowNodeEvent<'uiLevelChanged', TData> {}
export interface IAcDGDataChangedEvent<TData = any> extends RowNodeEvent<'dataChanged', TData> {
    oldData: TData | undefined;
    newData: TData | undefined;
    update: boolean;
}
export interface IAcDGCellChangedEvent<TData = any> extends RowNodeEvent<'cellChanged', TData> {
    column: Column;
    newValue: TData | undefined;
    oldValue: TData | undefined;
}

export interface IAcDGSelectableChangedEvent<TData = any> extends RowNodeEvent<'selectableChanged', TData> {}
export interface IAcDGDisplayedChangedEvent<TData = any> extends RowNodeEvent<'displayedChanged', TData> {}
export interface IAcDGMasterChangedEvent<TData = any> extends RowNodeEvent<'masterChanged', TData> {}
export interface IAcDGGroupChangedEvent<TData = any> extends RowNodeEvent<'groupChanged', TData> {}
export interface IAcDGHasChildrenChangedEvent<TData = any> extends RowNodeEvent<'hasChildrenChanged', TData> {}
export interface IAcDGRowHighlightChangedEvent<TData = any> extends RowNodeEvent<'rowHighlightChanged', TData> {}
export interface IAcDGDraggingChangedEvent<TData = any> extends RowNodeEvent<'draggingChanged', TData> {}

export type RowPinnedType = 'top' | 'bottom' | null | undefined;

export interface IAcDGVerticalScrollPosition {
    top: number;
    bottom: number;
}

interface IAcDGBaseRowNode<TData = any> {
...
interface IAcDGGroupRowNode<TData = any> {
