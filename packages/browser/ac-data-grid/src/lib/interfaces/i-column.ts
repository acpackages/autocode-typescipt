...
export interface IAcDGColumn<TValue = any>
...
export interface IAcDGColumnGroup<TValue = any> extends IHeaderColumn<TValue, AgColumnGroupEvent> {
...
export interface IAcDGProvidedColumnGroup extends IProvidedColumn, IEventEmitter<AgProvidedColumnGroupEvent> {
