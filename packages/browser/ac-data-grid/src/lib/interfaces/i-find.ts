...
export interface IAcDGFindMatch<TData = any, TValue = any> {
    node: IRowNode<TData>;
...
export interface IAcDGFindOptions {
...
export interface IAcDGFindCellParams<TData = any, TValue = any> {
    node: IRowNode<TData>;
    /** `null` if the cell is a full width row or detail row. */
    column: Column<TValue> | null;
}

export interface IAcDGFindCellValueParams<TData = any, TValue = any> extends FindCellParams<TData, TValue> {
...
export interface IAcDGFindPart {
...
export interface IAcDGGetFindMatches<TData = any> {
    (params: GetFindMatchesParams<TData>): number;
}

export interface IAcDGGetFindMatchesParams<TData = any> {
    node: IRowNode<TData>;
    data: TData;
...
export interface IAcDGFindDetailCellRendererParams<TData = any> {
    /**
...
export interface IAcDGFindDetailGridCellRendererParams<TData = any> {
    /**
...
export interface IAcDGFindFullWidthCellRendererParams<TData = any> {
    /**
...
export interface IAcDGFindGroupRowRendererParams<TData = any, TValue = any> {
    /**
