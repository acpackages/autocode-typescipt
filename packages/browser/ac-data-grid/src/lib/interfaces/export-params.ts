...
export interface IAcDGExportFileNameGetterParams<TData = any, TContext = any> extends AgGridCommon<TData, TContext> {}

export type ExportFileNameGetter = (params?: ExportFileNameGetterParams) => string;

export interface IAcDGBaseExportParams {
    /**
...
export interface IAcDGExportParams<T> extends BaseExportParams {
    /**
...
export interface IAcDGCsvCellData {
...
export interface IAcDGCsvExportParams extends ExportParams<CsvCustomContent> {
    /**
...
export interface IAcDGShouldRowBeSkippedParams<TData = any, TContext = any> extends AgGridCommon<TData, TContext> {
    /** Row node. */
    node: IRowNode<TData>;
}

export interface IAcDGProcessCellForExportParams<TData = any, TContext = any> extends AgGridCommon<TData, TContext> {
    value: any;
...
export interface IAcDGProcessHeaderForExportParams<TData = any, TContext = any> extends AgGridCommon<TData, TContext> {
    column: Column;
}

export interface IAcDGProcessGroupHeaderForExportParams<TData = any, TContext = any> extends AgGridCommon<TData, TContext> {
    columnGroup: ColumnGroup;
}

export interface IAcDGProcessRowGroupForExportParams<TData = any, TContext = any> extends AgGridCommon<TData, TContext> {
    node: IRowNode<TData>;
    column?: Column;
}
