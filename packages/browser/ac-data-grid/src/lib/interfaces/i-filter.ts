...
export interface IAcDGBaseFilter {
    /**
...
export interface IAcDGProvidedFilterModel {
    filterType?: string;
}
...
export interface IAcDGBaseFilterParams<TData = any, TContext = any> extends AgGridCommon<TData, TContext> {
...
export interface IFilterParams<TData = any, TContext = any> extends BaseFilterParams<TData, TContext> {
     ...
     * to the IAcDGFilterChangedEvent object (useful for passing additional
     ...
     * The grid will respond with emitting a IAcDGFilterModifiedEvent.
 ...
 */
export interface IAcDGFilterModel {
    [colId: string]: any;
}
