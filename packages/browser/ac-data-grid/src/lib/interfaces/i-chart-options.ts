export interface IAcDGChartGroupsDef {
...
export interface IAcDGChartSettingsPanel {
...
export interface IAcDGChartPanelGroupDef<GroupType> {
...
export interface IAcDGChartFormatPanel {
...
export interface IAcDGChartDataPanel {
...
export interface IAcDGChartToolPanelsDef {
...
export interface IAcDGSeriesChartType {
    colId: string;
    chartType: ChartType;
