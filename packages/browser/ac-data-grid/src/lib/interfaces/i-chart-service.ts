...
export interface IAcDGGetChartImageDataUrlParams {
...
export interface IAcDGChartDownloadParams {
    /** The id of the created chart. */
    chartId: string;
...
export interface IAcDGCloseChartToolPanelParams {
    /** The id of the created chart. */
    chartId: string;
}
...
export interface IAcDGOpenChartToolPanelParams {
    /** The id of the created chart. */
    chartId: string;
...
export interface IAcDGChartModel {
    version?: string;
...
export interface IAcDGBaseCreateChartParams {
...
export interface IAcDGCreateRangeChartParams extends BaseCreateChartParams {
...
export interface IAcDGCreateCrossFilterChartParams extends BaseCreateChartParams {
...
export interface IAcDGCreatePivotChartParams extends BaseCreateChartParams {}

export type UpdateChartParams = UpdateRangeChartParams | UpdatePivotChartParams | UpdateCrossFilterChartParams;

interface IAcDGBaseUpdateChartParams {
...
export interface IAcDGUpdateRangeChartParams extends BaseUpdateChartParams {
...
// When updating, also update `ChartParamsValidator`
export interface IAcDGUpdatePivotChartParams extends BaseUpdateChartParams {
    type: 'pivotChartUpdate';
}

// When updating, also update `ChartParamsValidator`
export interface IAcDGUpdateCrossFilterChartParams extends BaseUpdateChartParams {
