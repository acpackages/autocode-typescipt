...
export interface IAcDGSizeColumnsToFitGridColumnLimits {
    colId: string;
...
export interface IAcDGSizeColumnsToFitGridStrategy {
    type: 'fitGridWidth';
...
export interface IAcDGSizeColumnsToFitProvidedWidthStrategy {
 ...
 */
export interface IAcDGSizeColumnsToContentStrategy {
