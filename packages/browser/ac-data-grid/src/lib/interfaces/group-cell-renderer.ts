...
export interface IAcDGFooterValueGetterFunc {
    (params: GroupCellRendererParams): any;
}

export interface IAcDGTotalValueGetterFunc {
    (params: GroupCellRendererParams): any;
}
...
export interface IAcDGGroupCheckboxSelectionCallback<TData = any, TValue = any> {
