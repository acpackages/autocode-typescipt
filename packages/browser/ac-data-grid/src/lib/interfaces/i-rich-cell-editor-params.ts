...
export interface IAcDGRichSelectParams<TValue = any> extends AgPickerFieldParams {
    value?: TValue[] | TValue;
    valueList?: TValue[];
    allowTyping?: boolean;
    cellRenderer?: any;
...
export interface IAcDGRichCellEditorValuesCallback<TData = any, TValue = any> {
...
export interface IAcDGRichCellEditorParams<TData = any, TValue = any, TContext = any>
