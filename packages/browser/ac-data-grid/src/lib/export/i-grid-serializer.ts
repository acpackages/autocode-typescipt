...
export interface IAcDGRowAccumulator {
    onColumn(column: AgColumn, index: number, node?: RowNode): void;
}

export interface IAcDGRowSpanningAccumulator {
    onColumn(
...
export interface IAcDGGridSerializingParams {
...
export interface IAcDGGridSerializingSession<T> {
