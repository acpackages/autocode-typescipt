...
export interface IAcDGValueParserLiteFunc<TData, TValue> {
...
export interface IAcDGValueFormatterLiteFunc<TData, TValue> {
...
export interface IAcDGDataTypeChecker<TData, TValue> {
...
interface IAcDGBaseDataTypeDefinition<TValueType extends BaseCellDataType, TData = any, TValue = any> {
...
export interface IAcDGTextDataTypeDefinition<TData = any> extends BaseDataTypeDefinition<'text', TData, string> {}

/** Represents a `'number'` data type (type `number`). */
export interface IAcDGNumberDataTypeDefinition<TData = any> extends BaseDataTypeDefinition<'number', TData, number> {}

/** Represents a `'boolean'` data type (type `boolean`). */
export interface IAcDGBooleanDataTypeDefinition<TData = any> extends BaseDataTypeDefinition<'boolean', TData, boolean> {}

/** Represents a `'date'` data type (type `Date`). */
export interface IAcDGDateDataTypeDefinition<TData = any> extends BaseDataTypeDefinition<'date', TData, Date> {}

/** Represents a `'dateString'` data type (type `string` that represents a date). */
export interface IAcDGDateStringDataTypeDefinition<TData = any> extends BaseDataTypeDefinition<'dateString', TData, string> {
...
export interface IAcDGObjectDataTypeDefinition<TData, TValue> extends BaseDataTypeDefinition<'object', TData, TValue> {}
