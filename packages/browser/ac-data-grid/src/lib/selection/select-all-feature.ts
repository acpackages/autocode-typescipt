...
import type { IAcDGDisplayedColumnsChangedEvent, SelectionEventSourceType } from '../events';
import {
...
export class AcDGSelectAllFeature extends BeanStub {
    ...
    private onDisplayedColumnsChanged(e: IAcDGDisplayedColumnsChangedEvent): void {
        if (!this.isAlive()) {
            return;
        }
