import type { AgCheckbox, IAcDataGridEvent, ComponentSelector, ElementParams } from 'ag-grid-community';
import {
    AgCheckboxSelector,
    AgToggleButton,
    Component,
...
export interface IAcDataGridGroupComponentParams {
    title?: string;
    enabled?: boolean;
...
interface IAcDGExpandChangedEvent extends IAcDataGridEvent<ExpandedChangedEventType> {
    expanded?: boolean;
}

interface IAcDGEnableChangeEvent extends IAcDataGridEvent<'enableChange'> {
    enabled: boolean;
}
