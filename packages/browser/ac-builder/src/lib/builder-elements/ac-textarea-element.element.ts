...
export class AcTextareaElement extends AcBuilderElement{
...
export const AC_BUILDER_TEXTAREA_ELEMENT:IAcBuilderElement = {
  category:'Form',
  name:'textarea',
  tag:'textarea',
  title:'Textarea',
  ...
  properties:[
    ...
    AC_FORM_PROPERTIES.rows as IAcBuilderElementProperty,
    AC_FORM_PROPERTIES.cols as IAcBuilderElementProperty,
    AC_FORM_PROPERTIES.wrap as IAcBuilderElementProperty,
  ...
  mediaSvg:AC_BUILDER_ICON_SVGS.textarea,
  instanceClass:AcTextareaElement
}
