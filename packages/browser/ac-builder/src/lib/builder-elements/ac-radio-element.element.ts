...
export class AcRadioElement extends AcBuilderElement{
...
export const AC_BUILDER_RADIO_ELEMENT:IAcBuilderElement = {
  category:'Form',
  name:'radio',
  tag:'input',
  title:'Radio',
  ...
  mediaSvg:AC_BUILDER_ICON_SVGS.radio,
  instanceClass:AcRadioElement
}
